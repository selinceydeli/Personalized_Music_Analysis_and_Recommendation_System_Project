...
<x-layout>
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="text-center mb-4">
            <button onclick="downloadNegativeRecommendations()" class="bg-blue-500 text-white px-4 py-2 rounded">Download
        ...
        @if ($recommendations && count($recommendations) > 0)
            <div class="p-6">
                <h2 class="text-2xl font-bold mb-4">Moody Song Mix For You</h2>
