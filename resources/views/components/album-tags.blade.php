...
<ul class="flex">
    ...
    <li class="flex items-center justify-center" style="background-color: red; color: white; border-radius: 0.25rem; padding: 0.5rem 0.75rem; margin-right: 0.5rem; font-size: 0.75rem;">
        {{ $genre }}
    </li>
    @endforeach
</ul>